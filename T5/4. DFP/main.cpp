...
1. Вычисление градиента целевой функции
2. Определение направления поиска с помощью аппроксимации обратной матрицы Гессе
3. Выполнение одномерного поиска вдоль найденного направления
4. Обновление аппроксимации матрицы Гессе
5. Повторение процесса до достижения условия сходимости
*/
